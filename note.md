...
# oppure manualmente:
docker build -t bookshelf-tracker:0.2.2 .

# 4. Pusha l'immagine
docker tag bookshelf-tracker:0.2.2 ghcr.io/stefano664/bookshelf-tracker:0.2.2
docker push ghcr.io/stefano664/bookshelf-tracker:0.2.2
